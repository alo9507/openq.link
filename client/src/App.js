...
class App extends Component {
  state = { loaded: false, cost: 0, itemName: "Example 1", result: undefined };
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <div>{this.state.result ? this.state.result.events.SupplyChainStep.returnValues._itemAddress : ""}</div>
      </div>
    );
  }
}
